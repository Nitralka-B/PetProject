...
class CardTransferMapperTest {
    ...
    void toDto_shouldMapEntityToDto() {
        ...
        entity.setCardTransferId(ID_999);
        SuspiciousCardTransferDto dto = mapper.toDto(entity);
        assertThat(dto).isNotNull();
        assertThat(dto.getCardTransferId()).isEqualTo(ID_999);
    ...
    void toEntity_shouldMapDtoToEntityWithoutId() {
        ...
        assertThat(entity.getCardTransferId()).isEqualTo(ID_999);
    ...
    void eventToDto_shouldMapCheckedEventToDto() {
        ...
        event.setId(ID_999);
        SuspiciousCardTransferDto dto = mapper.eventToDto(event);
        assertThat(dto).isNotNull();
        assertThat(dto.getCardTransferId()).isEqualTo(ID_999);
    ...
    void updateToDto_shouldMapCheckedEventToNotBlocked() {
        TransferChecked event = new TransferChecked();
        event.setId(ID_999);
        SuspiciousCardTransferDto dto = mapper.updateToDto(event);
        assertThat(dto).isNotNull();
        assertThat(dto.getCardTransferId()).isEqualTo(ID_999);
    ...
    void eventCleanToDto_shouldMapCheckedEventToNotBlocked() {
        TransferChecked event = new TransferChecked();
        event.setId(ID_999);
        SuspiciousCardTransferDto dto = mapper.eventCleanToDto(event);
        assertThat(dto).isNotNull();
        assertThat(dto.getCardTransferId()).isEqualTo(ID_999);
        assertThat(dto.getIsBlocked()).isEqualTo(TransferMapperConstants.NOT_BLOCKED);
        assertThat(dto.getIsSuspicious()).isEqualTo(TransferMapperConstants.NOT_SUSPICIOUS);
